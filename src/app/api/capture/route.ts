...
- "chambres_libres" : la réception transmet aux équipes la liste des chambres libérées / départs faits / chambres à faire ("chambres libres 12 14 22", "départs ok : 5, 7 et 12", "libérées : 31 32"). Remplis "chambres" avec les numéros, dans l'ordre. NE PAS confondre avec une chambre libre demandée ou un problème en chambre.
