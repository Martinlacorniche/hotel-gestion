                  ...
                  <div className="border-b border-gray-100" style={{display:'grid',gridTemplateColumns:COLS}}>
                    ...
                    {WEEK.map(({d,str,tod})=>(
                      <div key={str} className="p-4 text-center border-r border-gray-100 last:border-r-0"
                        ...
                        {tod && <div className="w-1.5 h-1.5 rounded-full bg-[var(--brand-bg)]0 mx-auto mt-1" />}
                      </div>
                    ))}
                  </div>
                  ...
                  <div key={lead.id} onClick={() => openLeadModal(lead)}
                    ...
                    <div className="min-w-0 py-2">
                      <div className="flex items-center gap-1.5 min-w-0">
                        ...
                        {lead.groupe_id && <span className="text-[9px] font-bold px-1.5 py-0.5 rounded-md bg-[var(--brand-bg)] text-[var(--brand)] border border-[var(--brand)] shrink-0">👥</span>}
                    ...
                    <div className="flex items-center justify-end gap-1 pr-2">
                      ...
                      <button onClick={e => { e.stopPropagation(); handleDuplicate(lead); }} title="Dupliquer"
                        className="p-1 rounded-lg text-slate-300 hover:bg-[var(--brand-bg)] hover:text-[var(--brand)] transition-all opacity-0 group-hover:opacity-100"><Copy className="w-3.5 h-3.5" /></button>
                  ...
                  <div className="mr-auto flex gap-2">
                    {!currentLead.groupe_id && (
                      <button
                        ...
                        disabled={isSaving}
                        className="px-4 h-10 rounded-xl text-sm font-bold bg-[var(--brand-bg)] text-[var(--brand)] border border-[var(--brand)] hover:bg-[var(--brand-bg)] transition-all inline-flex items-center gap-1.5 disabled:opacity-50"
